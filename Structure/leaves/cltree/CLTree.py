...
from Structure.StatisticalTypes import Type
import logging
...
def create_cltree_leaf(data, ds_context, scope):
    assert len(scope) == data.shape[1], "scope miss match"
    from Structure.leaves.cltree.MLE import update_cltree_parameters_mle
