from Inference.inference import log_likelihood, sum_log_likelihood, prod_log_likelihood
from Learning.validity import is_valid
from Structure.nodes import Product, Sum, Factorize, get_nodes_by_type, eval_spn_top_down
import numpy as np
import logging
