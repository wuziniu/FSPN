...
def learn_structure(
    ...
    tasks = deque()
    tasks.append((dataset, root, 0, initial_scope, initial_cond, None, None, False, False, False, False, None))

    while tasks:

        local_data, parent, children_pos, scope, condition, cond_fanout_data, rect_range, no_clusters,\
